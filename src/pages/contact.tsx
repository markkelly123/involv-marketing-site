...
const faqs = [
  {
    ...
    answer: "We typically respond to enquiries within 24 hours and can start most engagements within one to two week. For urgent compliance matters, we can often provide immediate guidance."
  },
  {
