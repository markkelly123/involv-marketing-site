...
export default function Insights({ posts }: InsightsPageProps) {
  return (
    <>
      <Head>
        <title>Insights - Involv</title>
        <meta name="description" content="Latest insights and articles from Involv" />
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Stay informed with the latest industry insights, compliance updates, and expert analysis.
            </p>
          </div>
          
          {posts.length === 0 ? (
            <div className="text-center text-gray-400 py-12">
              <p className="text-xl mb-4">No posts found. Make sure you have content in your Sanity studio.</p>
              <p>
